...
}, "color"> & Pick<any, string | number | symbol> & {
...
export declare const Large: StoryObj<typeof Button>;
export declare const Primary: StoryObj<typeof Button>;
export declare const Secondary: StoryObj<typeof Button>;
export declare const Muted: StoryObj<typeof Button>;
export declare const Link: StoryObj<typeof Button>;
export declare const Outline: StoryObj<typeof Button>;
export declare const PrimaryOutline: StoryObj<typeof Button>;
export declare const SecondaryOutline: StoryObj<typeof Button>;
export declare const MutedOutline: StoryObj<typeof Button>;
export declare const Test: {
    render: () => JSX.Element;
};
export declare const Pair: StoryObj<typeof Button>;
